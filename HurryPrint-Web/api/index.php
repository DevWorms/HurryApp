<?php
    ...
    require 'controladores/saldo.php';
    require 'controladores/sucursales.php';
    require 'controladores/folios.php';
    require 'controladores/folio.php';
    require 'controladores/impresion.php';
    ...
    $recursos_existentes = array('saldo', 'usuarios', 'sucursales', 'folios', 'folio', 'impresion');
