...
<head>
  ...
  <script src="controladoresjs/PostFormularios.js"></script>
</head>
<body>
			...
			<nav class="top-bar">
			  ...
			  <section class="top-bar-section">
			    <ul class="right" id="menu">
			      ...
			      <li data-magellan-arrival="contact"><a href="#" data-reveal-id="myModal">LogIn</a></li>
			    </ul>
			  </section>
			</nav>
		</div>
  ...
  <div class="medium-6 medium-centered large-4 large-centered columns">
    ...
    <form>
    	<div class="row column log-in-form">
	       	<h4 class="text-center">Ingresa con tu correo</h4>
	       	<label>Correo
	       		<input type="text" id="email" placeholder="alguien@ejemplo.com">
	       	</label>
	       	<label>Password
	       		<input type="text"  id="pass" placeholder="Password">
	       	</label>
	       		<input id="show-password" type="checkbox"> Mostrar Password<label for="show-password">
	       	</label>
	       	<p><a type="submit" class="button expanded">Ingresar</a></p>
	       	<p class="text-center"><a href="user/">¿Olvidaste tu correo?</a></p>   
      </div>
    </form>
